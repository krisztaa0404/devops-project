...
echo "  🌐 Spring Boot App: http://localhost:8080 or http://devops-project.test:8080"
echo "  📈 Prometheus: http://localhost:9090 or http://devops-project.test:9090"
echo "  📊 Grafana: http://localhost:3001 or http://devops-project.test:3001"
echo "  🔍 Elasticsearch: http://localhost:9200 or http://devops-project.test:9200"
echo "  📈 Elasticsearch Exporter: http://localhost:9114/metrics or http://devops-project.test:9114/metrics"
echo "  🔍 Kibana: http://localhost:5601 or http://devops-project.test:5601"
echo ""
